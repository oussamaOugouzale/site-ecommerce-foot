<?php
$page_one 	= get_theme_mod( 'teams_page_one', '' );
$page_two 	= get_theme_mod( 'teams_page_two', '' );
$page_three = get_theme_mod( 'teams_page_three', '' );
...
if( !get_theme_mod( 'disable_teams_section', true ) && $has_page ){ ?>
	<section class="section-teams-area">
		<div class="content-wrap">
			<div class="row">
				<?php foreach( $page_array as $each_page ){ ?>
					<div class="col-md-4">
						<article class="post teams-content-wrap text-left">
