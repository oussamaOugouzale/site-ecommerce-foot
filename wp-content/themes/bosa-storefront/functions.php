...
if ( ! function_exists( 'bosa_storefront_enqueue_styles' ) ) :
	/**
	 * @since Bosa Storefront 1.0.0
	 */
	function bosa_storefront_enqueue_styles() {
        require_once get_theme_file_path( 'inc/wptt-webfont-loader.php' );

		wp_enqueue_style( 'bosa-storefront-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
        ...
        wp_enqueue_style(
            'bosa-storefront-google-fonts-two',
...
add_action( 'wp_enqueue_scripts', 'bosa_storefront_enqueue_styles', 10 );

/**
* Add cart link
* @since Bosa Storefront 1.0.0
*/
if ( !function_exists( 'bosa_storefront_cart_link' ) ) {
    function bosa_storefront_cart_link() {
        ?>	
...
* @since Bosa Storefront 1.0.0
*/
if ( !function_exists( 'bosa_storefront_header_cart' ) ) {
    function bosa_storefront_header_cart() {
        ?>
            <div class="header-cart">
                <div class="header-cart-block">
                    <div class="header-cart-inner">
                        <?php bosa_storefront_cart_link(); ?>
...
* @since Bosa Storefront 1.0.0
*/
if ( !function_exists( 'bosa_storefront_header_add_to_cart_fragment' ) ) {
    function bosa_storefront_header_add_to_cart_fragment( $fragments ) {
        ob_start();
        bosa_storefront_cart_link();
        $fragments['a.cart-icon'] = ob_get_clean();
        return $fragments;
    }
    add_filter( 'woocommerce_add_to_cart_fragments', 'bosa_storefront_header_add_to_cart_fragment' );
}
...
* @since Bosa Storefront 1.0.0
*/
if ( !function_exists( 'bosa_storefront_head_wishlist' ) ) {
    function bosa_storefront_head_wishlist() {
            ...
            <div class="header-wishlist">
                <a href="<?php echo esc_url( $wishlist_url ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Wishlist', 'bosa-storefront' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Storefront 1.0.0
*/
if (!function_exists( 'bosa_storefront_head_compare' ) ) {
    function bosa_storefront_head_compare() {
        if ( function_exists( 'yith_woocompare_constructor' ) ) {
            ...
            <div class="header-compare">
                <a class="compare added" rel="nofollow" href="<?php echo esc_url( $yith_woocompare->obj->view_table_url() ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Compare', 'bosa-storefront' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Storefront 1.0.0
*/
if ( !function_exists( 'bosa_storefront_my_account' ) ) {
    function bosa_storefront_my_account() {
            ...
            <div class="header-my-account">
                <div class="header-login"> 
                    <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>">
                        ...
                        <span class="info-tooltip">
                            <?php esc_html_e( 'My Account', 'bosa-storefront' ); ?>
                        </span>
                    </a>
                </div>
            </div>
...
* @return array.
*/
function bosa_storefront_get_pages(){
...
* @since Bosa Storefront 1.0.0
*/
if( !function_exists( 'bosa_storefront_blog_advertisement_banner' ) ){
    function bosa_storefront_blog_advertisement_banner(){
...
if ( ! function_exists( 'bosa_storefront_grid_thumbnail_date' ) ) :
    /**
     * Prints HTML with meta information for the tags and comments.
     */
    function bosa_storefront_grid_thumbnail_date() {
                    ...
                    comments_popup_link(
                        sprintf(
                            wp_kses(
                                ...
                                __( 'Comment<span class="screen-reader-text"> on %s</span>', 'bosa-storefront' ),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
...
if( !function_exists( 'bosa_get_intermediate_image_sizes' ) ){
    ...
    */
    function bosa_get_intermediate_image_sizes(){
        ...
        $data   = array(
            'full'          => esc_html__( 'Full Size', 'bosa-storefront' ),
            'large'         => esc_html__( 'Large Size', 'bosa-storefront' ),
            'medium'        => esc_html__( 'Medium Size', 'bosa-storefront' ),
            'medium_large'  => esc_html__( 'Medium Large Size', 'bosa-storefront' ),
            'thumbnail'     => esc_html__( 'Thumbnail Size', 'bosa-storefront' ),
            '1536x1536'     => esc_html__( '1536x1536 Size', 'bosa-storefront' ),
            '2048x2048'     => esc_html__( '2048x2048 Size', 'bosa-storefront' ),
            'bosa-1920-550' => esc_html__( '1920x550 Size', 'bosa-storefront' ),
            'bosa-1370-550' => esc_html__( '1370x550 Size', 'bosa-storefront' ),
            'bosa-590-310'  => esc_html__( '590x310 Size', 'bosa-storefront' ),
            'bosa-420-380'  => esc_html__( '420x380 Size', 'bosa-storefront' ),
            'bosa-420-300'  => esc_html__( '420x300 Size', 'bosa-storefront' ),
            'bosa-420-200'  => esc_html__( '420x200 Size', 'bosa-storefront' ),
            'bosa-290-150'  => esc_html__( '290x150 Size', 'bosa-storefront' ),
            'bosa-80-60'    => esc_html__( '80x60 Size', 'bosa-storefront' ),
        );
...
if( !function_exists( 'bosa_storefront_archive_post_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_archive_post_layout_filter', 'bosa_storefront_archive_post_layout_filter' );
    function bosa_storefront_archive_post_layout_filter( $post_layout ){
...
if( !function_exists( 'bosa_storefront_header_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_header_layout_filter', 'bosa_storefront_header_layout_filter' );
    function bosa_storefront_header_layout_filter( $header_layout ){
        $added_header = array(
...
if( !function_exists( 'bosa_storefront_footer_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_footer_layout_filter', 'bosa_storefront_footer_layout_filter' );
    function bosa_storefront_footer_layout_filter( $footer_layout ){
        $added_footer = array(
