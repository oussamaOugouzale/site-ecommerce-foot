...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_storefront_blog_advertisement_banner(); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-storefront' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-storefront' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-storefront' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-storefront' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-storefront' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
